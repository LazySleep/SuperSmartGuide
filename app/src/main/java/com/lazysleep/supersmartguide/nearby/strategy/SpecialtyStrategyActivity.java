...
public class SpecialtyStrategyActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_specialty_strategy);
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM specialty", null);
