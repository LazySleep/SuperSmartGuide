...
public class TrafficStrategyActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_traffic_strategy);
        ...
        while (cursor.moveToNext()) {
            ...
            String text = cursor.getString(cursor.getColumnIndex("way"))
                    .replace("\\t", "\t");
