...
public class TripStrategyActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trip_strategy);
        ...
        int i = 0;
        int[] colors = new int[]{0xFF5ED5D1, 0xFF1A2D27, 0xFFFF6E97, 0xFF7F1874, 0xFFDB9019, 0xFFF1AAA6};
